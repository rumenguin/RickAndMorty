...
final class RMLocationDetailView: UIView {
    ...
    private func createCollectionView() -> UICollectionView {
        ...
        collectionView.register(RMEpisodeInfoCollectionCell.self, forCellWithReuseIdentifier: RMEpisodeInfoCollectionCell.cellIdentifier)
...
extension RMLocationDetailView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .information(let viewModels):
            ...
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: RMEpisodeInfoCollectionCell.cellIdentifier, for: indexPath) as? RMEpisodeInfoCollectionCell else {
                fatalError()
            }
